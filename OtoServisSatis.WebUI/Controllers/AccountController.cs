...
namespace OtoServisSatis.WebUI.Controllers
{
    public class AccountController : Controller
    {
        ...
        [Authorize(Policy = "CustomerPolicy")] //markalara sadece admin erişebilir
        ...
        public async Task<IActionResult> RegisterAsync(Kullanici kullanici)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("", "Kayıt Olunurken Bir Hata Oluştu");
                }
            }
            return View();
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    var claims = new List<Claim>()
                    {
                        ...
                        //farklı claim tipleri de eklenebilir
